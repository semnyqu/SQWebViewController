...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    /*
    NSBundle *bundle = [NSBundle bundleForClass:NSClassFromString(@"SQWebViewController")];
    NSString *bundlePath = [bundle pathForResource:@"SQWebViewController.bundle/html.bundle/404" ofType:@"html"];
     */
    /*
    SQWebViewController *webVC = [[SQWebViewController alloc] initWithAddress:@"https://www.baidu.com"];
    webVC.showsToolBar = NO;
    webVC.webView.allowsLinkPreview = YES;
    webVC.navigationType = SQWebViewControllerNavigationBarItem;
